m=[ { "name": "Forrest Gump", "year": 1994, "duration": 142, "genres": ["Drama", "Romance"] },
...
def search():
    ...
    found_movies = [movie for movie in m if search_term in movie["name"].lower()]
